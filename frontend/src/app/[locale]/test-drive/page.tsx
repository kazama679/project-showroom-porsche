...
import { ConfiguratorModel, formatPrice } from '@/utils/configurator-data'
import { carBuildApi } from '@/services/car-build-api'
import { testDriveApi, TestDriveBookingRequest } from '@/services/test-drive-api'
...
function TestDriveContent() {
  ...
  const [formData, setFormData] = useState({
    ...
    countryCode: 'Mỹ +1',
    phone: '',
    message: 'Tôi muốn đăng ký lái thử mẫu xe này.',
    preferredDate: '',
    preferredTime: 'Sáng (08:00 - 12:00)',
  })
  ...
  const handleSubmit = async () => {
    ...
    if (!hasError) {
      ...
      try {
        ...
        const payload: TestDriveBookingRequest = {
          ...
          carModelId: modelData?.id ? Number(modelData.id) : undefined,
          preferredDate: formData.preferredDate || undefined,
          preferredTime: formData.preferredTime || undefined,
        }
        
        await testDriveApi.createBooking(payload)
        setIsSubmitted(true)
      ...
      <main className="max-w-[1200px] mx-auto px-4 md:px-8 py-8">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto px-4">
          ...
          <p className="text-base text-near-black font-light">
            Trải nghiệm cảm giác lái đẳng cấp. Hãy để lại thông tin để chúng tôi sắp xếp lịch lái thử cho bạn.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-6 md:p-8 rounded-[20px] shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-sm font-medium text-near-black mb-1.5">
                    Thời gian lịch hẹn dự kiến
                  </h3>
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1">
                      <label className="block text-xs text-dark-gray font-light mb-1">Ngày dự kiến</label>
                      <input
                        type="date"
                        name="preferredDate"
                    ...
                    <div className="flex-1">
                      <label className="block text-xs text-dark-gray font-light mb-1">Thời gian</label>
                      <select
                        name="preferredTime"
                        ...
                        className="w-full px-4 py-3.5 bg-gray-100 border border-gray-200 rounded-xl font-light text-near-black focus:outline-none focus:border-neutral-400 appearance-none"
                      >
                        <option value="Sáng (08:00 - 12:00)">Sáng (08:00 - 12:00)</option>
