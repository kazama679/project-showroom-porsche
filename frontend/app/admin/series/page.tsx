    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-dark-surface border border-light-gray-surface dark:border-dark-surface rounded-sm p-5">
            <p className="text-xs font-medium text-mid-gray dark:text-light-gray-surface uppercase tracking-wider">{t('admin.series_total')}</p>
      ...
      <Modal isOpen={isDeleteModalOpen} onClose={() => setIsDeleteModalOpen(false)} title={t('admin.series_confirm_delete')} size="sm"
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm text-near-black dark:text-light-gray-surface">{t('admin.series_confirm_delete_msg')}</p>
