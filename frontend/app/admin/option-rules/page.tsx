        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-[#181818] dark:text-[#D2D2D2]">
              {t('admin.source_option')} <span className="text-[#DA291C]">*</span>
            </label>
            <select
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-[#181818] dark:text-[#D2D2D2]">
              {t('admin.rule_type')} <span className="text-[#DA291C]">*</span>
            </label>
            <select
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-[#181818] dark:text-[#D2D2D2]">
              {t('admin.target_option')} <span className="text-[#DA291C]">*</span>
            </label>
            <select
